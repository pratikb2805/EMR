...
class _MedicineListEntityListState extends State<MedicineListEntityList> {
  ...
  //     StreamController<List<MedicineListEntity>>(sync: true);
  // final MedicineListEntityModel vm = MedicineListEntityModel();
  ...
  void initState() {
    ...
    setState(() {
      // _listController.addStream(vm.queryMedicineListEntityStream.map((q) => q.find()));
...
// List<MedicineListEntity> parseData(String responseBody) {
//   final parsed = json.decode(responseBody).cast<Map<String, dynamic>>();
//   return parsed.map<MedicineListEntity>((json) => MedicineListEntity.fromJson(json)).toList();
// }
...
class _MedicineListEntityDataTableState
  ...
  void initstate() {
    // print(widget.MedicineListEntitys);
    setState(() {
      MedicineListEntitys = widget.MedicineListEntitys;
      _source = MedicineListEntityDataSource(MedicineListEntitys, widget.vm);
    });
  ...
  // Future<List<MedicineListEntity>> fetchData() async {
  //   final String response =
  //       await rootBundle.loadString('assets/data/MedicineListEntity.json');
  //   final parsed = json.decode(response).cast<Map<String, dynamic>>();
  //   return parsed.map<MedicineListEntity>((json) => fromJson(json)).toList();
  // }

  // MedicineListEntity fromJson(Map<String, dynamic> json) {
  //   return MedicineListEntity(
  ...
  //   if (!isLoaded) {
  //     MedicineListEntitys = await fetchData();
  //     setState(() {
  //       isLoaded = true;
  //       _source = MedicineListEntityDataSource(MedicineListEntitys);
  //     });
  //   }
  // }
